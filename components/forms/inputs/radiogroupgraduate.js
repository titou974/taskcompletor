...
import { graduateAnswersList } from '../../../utils/constants/index';


const RadioGroupGraduateAnswers = ({graduate, setGraduate}) => {

  return (
    <div className="w-full pt-10">
      <div className="mx-auto w-full">
        <RadioGroup value={graduate} onChange={setGraduate}>
          <RadioGroup.Label className="sr-only">Graduate?</RadioGroup.Label>
          <div className="space-y-2">
            {graduateAnswersList.map((graduateAnswers) => (
              <RadioGroup.Option
                key={graduateAnswers.id}
                value={graduateAnswers.graduate}
...
export default RadioGroupGraduateAnswers;
