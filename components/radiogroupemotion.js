  ...
  return (
    <div className="w-full pt-10">
      <div className="mx-auto w-full">
        <RadioGroup value={emotion} onChange={setEmotion}>
          <RadioGroup.Label className="sr-only">Langue</RadioGroup.Label>
          <div className="space-y-2">
            {emotions.map((emotionSelected) => (
              <RadioGroup.Option
                key={emotionSelected.id}
                value={emotionSelected.id}
...
export default RadioGroupEmotion;
