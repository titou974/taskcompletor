...
export const docType = [
  ...
  },
  {
    ...
    example_2: {
      details: [['Titouan Hirsch', '98 rue Montmartre', 'titouanhirsch@gmail.com', '0603465422'], ['Agence Koukou', 'Marseille'], ['Le 18 octobre 2023']],
      object: "Objet : Candidature au poste de Développeur Web",
      letter: ["Madame, Monsieur", "Passionné par le développement web, je me permets de vous adresser ma candidature pour le poste de Développeur Web au sein de votre agence Koukou. Diplômé d’une certification de Concepteur Développeur d'applications webs obtenue après une formation de Bac+3 en Programmation Web à l'école Le Wagon Paris, j'ai acquis une solide maîtrise des langages de programmation comme HTML/CSS, JavaScript, PHP et une bonne connaissance des systèmes de gestion de base de données comme SQL, MongoDB.", "Durant ma formation, j'ai eu l'opportunité de travailler sur le projet Task Completor, un outil innovant qui permet de compléter ses tâches du quotidien grâce à l'API de GPT 4. Cette expérience m'a permis de renforcer mes compétences en développement web et d'acquérir une excellente maîtrise des systèmes de gestion de contenu tels que WordPress, Drupal. J'ai également développé une compréhension approfondie du responsive design et du développement cross-browser.", "De plus, soucieux de l'optimisation du référencement, j'ai une bonne connaissance des principes de SEO (Search Engine Optimization). Je suis convaincu que ces compétences, alliées à ma capacité à travailler en équipe et à ma passion pour le développement web, me permettront de m'intégrer rapidement à vos équipes et de contribuer efficacement à vos projets.", "Intégrer votre agence représente pour moi une réelle opportunité de mettre à profit mes compétences et mon expérience, tout en continuant à apprendre et à me développer professionnellement. Je suis convaincu qu'ensemble, nous pourrons réaliser des projets innovants et stimulants.", "Je reste à votre disposition pour toute information complémentaire ou pour un éventuel entretien afin de vous exposer plus en détail mon parcours et mes motivations.", "Dans l’attente de votre retour, je vous prie d’agréer, Madame, Monsieur, l’expression de mes salutations distinguées.", "Titouan Hirsch"]
    }
  },
];
